...
module.exports = yeoman.generators.Base.extend({
  ...
  prompting: function () {
    ...
    var prompts = [{
    	...
    	default: this.destinationRoot().substr(this.destinationRoot().lastIndexOf('/')+1)
    },
    {
    	type: 'input',
    	name: 'appDescription',
    ...
    },
    {
    	...
    	default: 'https://github.com/user/'+
    			  this.destinationRoot().substr(this.destinationRoot().lastIndexOf('/')+1)+
    			  '.git'
    }];
  ...
  writing: {
    ...
    backend: function () {
      ...
      this.copy('_app/_backend/_models/_enduring.js','app/backend/models/enduring.js');
    	this.copy('_app/_backend/_templates/_confirm-mail.js','app/backend/templates/confirm-mail.js');
    	this.copy('_app/_backend/_templates/_theft-mail.js','app/backend/templates/theft-mail.js');
